//Lab-5
/*Write a program to implement the following on strings.
a) Reverse of the given string.
b) Check whether the given sting is Palindrome or not.
d) Sort an array of strings
*/
